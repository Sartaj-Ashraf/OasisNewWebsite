...
const stats = [
  ...
  { number: "15M+", label: "Audience Reached" },
...
const services = [
  {
    ...
    desc: "Build a strong brand presence through strategic content creation, audience engagement, and community growth.",
    Image:
  ...
  },
  {
    ...
    desc: "Generate qualified leads and sales with highly targeted Google, Meta, and LinkedIn advertising campaigns.",
    Image:
  ...
  },
  {
    ...
    desc: "Create engaging content that attracts, educates, and converts your ideal customers.",
    Image:
  ...
  },
  {
    ...
    desc: "Build customer loyalty and increase retention through personalized email campaigns.",
    Image:
  ...
  },
  {
    ...
    desc: "Monitor campaign performance with detailed reporting and actionable business insights.",
    Image:
  ...
  },
  {
    ...
    desc: "Improve search rankings and attract high-intent traffic through proven SEO strategies.",
    Image:
...
const reasons = [
  {
    ...
    desc: "We combine digital marketing and social media into one unified strategy designed to accelerate business growth.",
  },
  {
    title: "Data-Driven Decisions",
    desc: "Every campaign is guided by performance metrics, audience insights, and continuous optimization.",
  },
  {
    title: "Multi-Channel Expertise",
    desc: "From SEO and content marketing to paid advertising and social media management, we cover every aspect of your digital presence.",
  },
  {
    title: "Transparent Reporting",
    desc: "Clear reporting and regular updates ensure you always understand your campaign performance and return on investment.",
  },
];
/* ── Scroll-reveal hook ───────────────────────────────────────── */
        ...
        <div ref={servicesRef}>
          ...
          >
            ...
            <p className="text-lg text-slate-600">
              A complete blend of digital marketing and social media services
              designed to increase visibility, generate leads, and drive
              sustainable growth.
            </p>
          </div>
        ...
        >
          ...
          >
            ...
            <p className="text-lg text-slate-600 leading-relaxed mb-8">
              Oasis Ascend helps businesses grow through a powerful combination
              of digital marketing and social media expertise. We focus on
              increasing visibility, generating qualified leads, and building
              long-term customer relationships through data-driven strategies.
            </p>

            <div className="p-6 bg-slate-50 border border-slate-100 rounded-xl border-l-4 border-l-secondary">
              <p className="text-slate-700 font-medium italic">
                "Oasis Ascend transformed our online presence. Their combined
                digital marketing and social media strategy significantly
                increased our traffic, lead quality, and overall business
                growth."
              </p>

              <div className="mt-4 font-bold text-slate-900 text-sm">
                Marketing Director, Client Partner
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            {reasons.map((reason, i) => (
              ...
              >
                ...
                <div>
                  <h5 className="text-2xl! font-medium text-slate-900 mb-1">
                    {reason.title}
                  </h5>

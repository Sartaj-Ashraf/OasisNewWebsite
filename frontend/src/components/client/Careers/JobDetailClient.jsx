      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 py-6 sm:py-10">
        <div className="flex flex-col lg:grid lg:grid-cols-[1fr_380px] gap-6 items-start">
          ...
          <div className="w-full space-y-5 min-w-0">
            ...
            {/* Header card */}
            <div className="bg-gray-50 rounded-3xl border border-slate-100 shadow-[0_2px_24px_rgba(0,0,0,0.04)] p-6 sm:p-8 md:p-10">
              <JobDetailHeader job={job} />
            </div>

            {/* Content card */}
            <div className="bg-gray-50 rounded-3xl border border-slate-100 shadow-[0_2px_24px_rgba(0,0,0,0.04)] overflow-hidden">
              <JobSection
          ...
          <div className="w-full lg:sticky lg:top-20 lg:max-w-[380px] lg:w-[380px] flex-shrink-0">

        ...
        <div className="flex flex-col gap-6">
            ...
            <div className="relative rounded-2xl overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-6">
                ...
                <div className="relative flex items-start gap-4">
                    <div className="w-14 h-14 rounded-2xl bg-amber-400/20 border border-amber-400/30 flex items-center justify-center text-2xl flex-shrink-0">
                        💼
                    </div>
                    <div className="flex-1 min-w-0">
                        <h3 className="font-bold text-2xl! text-white leading-tight wrap-break"
                ...
                <div className="relative grid grid-cols-2 sm:grid-cols-4 gap-3 mt-5">
                    {[
                        ...
                        <div key={label} className="bg-white/5 border border-white/10 rounded-xl px-3 py-2.5 backdrop-blur-sm">
                            ...
                            <div className="text-sm text-white font-semibold mt-0.5 leading-tight">{value}</div>
                        </div>
                    ))}
                </div>
            </div>

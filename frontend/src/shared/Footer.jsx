...
export const Footer = () => {
  return (
    <footer className="container py-6">
      <div className=" h-screen md:h-[70vh] max-h-[500px] bg-secondary-dark rounded-3xl relative">
        ...
        <div className="absolute  md:-right-[1px] -right-26 -bottom-1 ">
          ...
          />
          <p className="text-secondary-dark absolute bottom-5 md:bottom-5 left-15 md:left-20 z-10 text-[8px] md:text-sm">
            Copyright © 2025 Oasis. All rights reserved.
          </p>
        </div>
        <div className="container mx-auto px-4 h-full">
          <div className="flex items-center  gap-20 h-full">
            ...
            <div className="flex flex-col  h-full gap-2 md:pt-25">
              <span className="text-lg md:text-3xl font-medium text-primary-light">
                Contact Us
              </span>
              <ul className="flex flex-col gap-2">
